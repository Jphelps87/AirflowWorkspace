...
if [ ! -d $DOMINO_WORKING_DIR/airflow ]; then
	...
	#base_url
	sed -i '285#http://localhost:8080/airflow#https://demo.dominodatalab.com/${DOMINO_PROJECT_OWNER}/${DOMINO_PROJECT_NAME}/notebookPublicUrl/${DOMINO_RUN_ID}#' "$DOMINO_WORKING_DIR"/airflow/airflow.cfg
